...
description = """The Kapteyn Package is a collection of Python modules and
applications developed by the computer group of the Kapteyn Astronomical
Institute, University of Groningen, The Netherlands.
The purpose of the package is to provide tools for the development of
astronomical applications with Python.  This package is still being
developed and possibly some interfaces can change in a next release. 
Base module wcs has intensively been tested and should be stable.  The
wcs module supports:
