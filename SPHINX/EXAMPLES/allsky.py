...
def plotfig(fignum, smallversion=False):
   ...
   if fignum == 1:
      ...
      title = r"""Plate Carree projection (CAR), non oblique with:
            ...
            $(\alpha_0,\delta_0,\phi_p) = (120^o,0^o,0^o)$. (Cal. fig.2)"""
      ...
      title = r"""Plate Carree projection (CAR), oblique with:
            $(\alpha_0,\delta_0,\phi_p) = (120^o,0^o,0^o)$
      ...
      grat = wcsgrat.Graticule(header, axnum=(1,2), wylim=(lowval,90.0), wxlim=(0,360),
                              startx=X, starty=Y)
      ...
      title = r"""Slant zenithal perspective (SZP) with:
               ($\mu,\phi,\theta)=(2,180,60)$ with special algorithm
                  for border (Cal. fig.7)"""
      header = {'NAXIS' : 2, 'NAXIS1': 100, 'NAXIS2': 80,
               'CTYPE1' : 'RA---SZP',
      ...
      grat = wcsgrat.Graticule(header, axnum=(1,2), wylim=(-90.0,90.0), wxlim=(-180,180),
                              startx=X, starty=Y)
      pixel = grat.gmap.topixel((82,-30))
      grat.setp_lineswcs0(0, lw='2')
      grat.setp_lineswcs1(0, lw='2')
      ...
      title = r"Airy projection (AIR) with $\theta_b = 45^o$. (Cal. fig.14)"
      header = {'NAXIS' : 2, 'NAXIS1': 100, 'NAXIS2': 80,
               'CTYPE1' : 'RA---AIR',
               'CRVAL1' :0.0, 'CRPIX1' : 50, 'CUNIT1' : 'deg', 'CDELT1' : -4.0,
               'CTYPE2' : 'DEC--AIR',
   ...
   # CYLINDRICALS
      ...
      title =  r"Gall's stereographic projection (CYP) with $\mu = 1$ and $\theta_x = 45^o$. (Cal. fig.16)"
      header = {'NAXIS'  : 2, 'NAXIS1': 100, 'NAXIS2': 80,
               'CTYPE1' : 'RA---CYP',
   ...
   # CONIC PROJECTIONS
      ...
      title = r"""Conic perspective projection (COP) with:
                  $\theta_a=45^o$, $\theta_1=20^o$ and $\theta_2=70^o$. (Cal. fig.24)"""
      header = {'NAXIS'  : 2, 'NAXIS1': 100, 'NAXIS2': 80,
               'CTYPE1' : 'RA---COP',
   ...
   # QUAD CUBE PROJECTIONS
      ...
      xhi, py = grat.gmap.topixel((-45.0, 0.0));
      px, yhi = grat.gmap.topixel((-180, +45));
      xs, py = grat.gmap.topixel((90, -45.0-epsilon));
      px, ylolo = grat.gmap.topixel((180, -45.0-epsilon));
      px, yhihi = grat.gmap.topixel((180, 45.0+epsilon));
      Xp = [xlo, xs, xhi, xs,  xs,   xhi,  xhi,  xs,   xs, xhi, xlo, xlo]
      Yp = [ylo, ylo,ylo, ylo, ylolo,ylolo,yhihi,yhihi,yhi,yhi, yhi, ylo]
      polygon = zip(Xp, Yp)
   elif fignum == 27:
      ...
      title = r"""Conic equidistant projection (COD) oblique with $\theta_a=45$, $\theta_1=20$
            ...
            $(\phi_0,\theta_0) = (0,90^o)$. (Cal. fig.33d)"""
      header = {'NAXIS'  : 2, 'NAXIS1': 100, 'NAXIS2': 80,
               'CTYPE1' : 'RA---COD',
      ...
      title = r"""Hammer Aitoff projection (AIT) oblique with:
                  $(\alpha_p,\delta_p) = (0^o,30^o)$, $\phi_p = 75^o$ also: 
                  $(\phi_0,\theta_0) = (0^o,90^o)$. (Cal. fig.34d)"""
      ...
      xhi, py = border.gmap.topixel((-45.0, 0.0));
      px, yhi = border.gmap.topixel((-180, +45));
      xs, py = border.gmap.topixel((90, -45.0-epsilon));
      px, ylolo = border.gmap.topixel((180, -45.0-epsilon));
      px, yhihi = border.gmap.topixel((180, 45.0+epsilon));
      Xp = [xlo, xs, xhi, xs,  xs,   xhi,  xhi,  xs,   xs, xhi, xlo, xlo]
      Yp = [ylo, ylo,ylo, ylo, ylolo,ylolo,yhihi,yhihi,yhi,yhi, yhi, ylo]
      polygon = zip(Xp, Yp)
   elif fignum == 36: 
      ...
      grat = wcsgrat.Graticule(header, axnum= (1,2), wylim=(-30,90.0), wxlim=(-20,60),
      ...
      grat.setp_plotaxis(wcsgrat.bottom, mode=wcsgrat.bothticks, label='Latitude / Longitude')
      grat.setp_plotaxis(wcsgrat.left, mode=wcsgrat.notnative, label='Latitude')
      grat.setp_plotaxis(wcsgrat.right, mode=wcsgrat.native)
      grat.setp_tick(wcsaxis=0, color='g')
      grat.setp_tick(wcsaxis=1, color='m')
      grat.setp_tick(wcsaxis=1, plotaxis=(wcsgrat.bottom,wcsgrat.right), color='m', rotation=-30, ha='left')
      ...
      grat.setp_linespecial(g, color='#B30000', lw=1)
      lat_world = lon_world = []
      drawgrid = True
      plotdata = True
      datasign = +1
      ...
      title = r"WCS conic equal area projection with $\theta_a=60$ and $\eta=15$ (PGSBOX fig.2)"
      header = {'NAXIS'  : 2, 'NAXIS1': 512, 'NAXIS2': 512,
               'CTYPE1' : 'RA---COE',
      ...
      title = r"""Bonne's equal area projection (BON) with conformal latitude $\theta_1=35$ and
               $\alpha_p=0^o$, $\theta_p=+45^o$ and N.C.P. at $(45^o,0^o)$. (PGSBOX example)"""
      header = {'NAXIS'  : 2, 'NAXIS1': 100, 'NAXIS2': 80,
               'CTYPE1' : 'RA---BON',
               'CRVAL1' : 0.0, 'CRPIX1' : 50, 'CUNIT1' : 'deg', 'CDELT1' : -4.0,
               'CTYPE2' : 'DEC--BON',
   ...
   if polygon != None:
      p = plt.Polygon(polygon, facecolor='#d6eaef')
      frame.add_patch(p)
   ...
   if oblique != None:
      gratplot.add(oblique)
      if not smallversion:
         txt ="""Green:  Native, non-oblique graticule
               Yellow: Equator and prime meridian
               Others: Colour coded oblique graticule"""
         plt.figtext(0.02, 0.05, txt)
   ...
   def on_move(event):
      if event.inaxes:
         ...
         try:
            xw, yw = wcsobj.toworld((x,y))
            s = "x,y: %.2f %.2f l,b: %.2f %.2f " % (x, y, xw, yw)
         except:
            s = "No World coord at x,y: %.2f %.2f " % (x, y)
         figmanager.toolbar.set_message(s)
   
   def click(event):
      print 'Pixel position', event.x, event.y
